...
const copy = {
  en: {
    ...
    eyebrow: 'SQUAD // NIGHT OPERATIONS', heroTitle: 'Night.<br><em>No limits.</em>', heroText: 'The Night Witches are a Squad clan for players who move quietly, communicate clearly, and own the objective before sunrise.', heroCta: 'Request deployment', heroRoster: 'View active roster', homeServerLabel: 'HOME SERVER', comingSoon: 'COMING SOON...', heroLocation: 'COMING SOON...',
    missionLabel: 'MISSION BRIEF', missionKicker: 'No spectators. No solo heroes.', missionTitle: 'Fly quiet.<br><span>Strike together.</span>', missionText: 'TMNW is a night operations unit for players who want Squad to feel like Squad: organized enough to be effective, relaxed enough to be fun. We build every sortie around teamwork, good leadership, and the next objective.', principleOne: 'DISCIPLINE', principleOneText: 'Comms that keep the squad moving.', principleTwo: 'TRUST', principleTwoText: 'Good players make good teammates.', principleThree: 'ADAPTATION', principleThreeText: 'Every plan changes on contact.', serverTitle: 'HOME SERVER // COMING SOON', serverText: 'Our home server is coming soon. Follow the Discord for the launch announcement.', philosophyTitle: 'PLAY YOUR WAY', philosophyText: 'No mandatory daily logins, no forced seeding, and no military-style pressure. We play for fun.', vipTitle: 'VIP AFTER FIRST SORTIE', vipText: 'VIP details will be announced when our home server launches.', leaveTitle: 'TAKING LEAVE?', leaveText: 'Tell an officer in the #увал channel so you are not caught by periodic inactivity purges.',
    personnelLabel: 'PERSONNEL', active: 'ACTIVE', activeNow: 'ACTIVE', deploymentKicker: 'Verified members', rosterTitle: 'Our <span>crew.</span>', memberCount: 'ACTIVE MEMBERS', leadCard: 'OFFICER', memberCard: 'MEMBER', filterRoster: 'Filter roster', filterAll: 'All', filterOfficers: 'Leads', filterInfantry: 'Players',
  ...
  ru: {
    ...
    eyebrow: 'SQUAD // НОЧНЫЕ ОПЕРАЦИИ', heroTitle: 'Ночь.<br><em>Без границ.</em>', heroText: '«Команда Ночных Ведьм» — клан Squad для тех, кто двигается тихо, говорит чётко и берёт цель до рассвета.', heroCta: 'Запросить вылет', heroRoster: 'Смотреть состав', homeServerLabel: 'ДОМАШНИЙ СЕРВЕР', comingSoon: 'СКОРО...', heroLocation: 'СКОРО...',
    missionLabel: 'БРИФИНГ МИССИИ', missionKicker: 'Без зрителей. Без одиночек.', missionTitle: 'Летим тихо.<br><span>Бьём вместе.</span>', missionText: 'TMNW — подразделение ночных операций для тех, кто хочет играть в Squad как в Squad: организованно и эффективно, но без потери удовольствия. Каждый вылет строится на командной работе, лидерстве и следующей цели.', principleOne: 'ДИСЦИПЛИНА', principleOneText: 'Связь, которая ведёт отряд вперёд.', principleTwo: 'ДОВЕРИЕ', principleTwoText: 'Хорошие игроки делают хороших напарников.', principleThree: 'ГИБКОСТЬ', principleThreeText: 'При контакте любой план меняется.', serverTitle: 'ДОМАШНИЙ СЕРВЕР // СКОРО', serverText: 'Домашний сервер появится скоро. Следи за Discord, чтобы не пропустить запуск.', philosophyTitle: 'ИГРАЙ КАК ХОЧЕШЬ', philosophyText: 'Без обязательных ежедневных заходов, форсированного сидирования и военного давления. Мы играем ради удовольствия.', vipTitle: 'VIP ПОСЛЕ ПЕРВОГО ВЫЛЕТА', vipText: 'Условия VIP будут объявлены после запуска домашнего сервера.', leaveTitle: 'УХОДИШЬ В УВАЛ?', leaveText: 'Сообщи офицеру в канале #увал, чтобы не попасть под периодическую чистку неактивных.',
    personnelLabel: 'ЛИЧНЫЙ СОСТАВ', active: 'АКТИВНЫХ', activeNow: 'АКТИВНО', deploymentKicker: 'Проверенный состав', rosterTitle: 'Наш <span>состав.</span>', memberCount: 'АКТИВНЫХ УЧАСТНИКОВ', leadCard: 'ОФИЦЕР', memberCard: 'УЧАСТНИК', filterRoster: 'Фильтр состава', filterAll: 'Все', filterOfficers: 'Офицеры', filterInfantry: 'Игроки',
...
function renderRoster(filter = 'all') {
  ...
  rosterGrid.innerHTML = visibleRoster.map((member, index) => `
    <article class="roster-card ${member.type}">
      ...
      <span class="card-online">${member.badge[language]}</span>
      <div class="card-avatar" aria-hidden="true">${initials(member.name)}</div>
      <div class="card-name">${member.name}</div>
      <div class="card-role">${member.roles[language]}</div>
      <div class="card-details"><span>${member.badge[language]}</span><span>TMNW // SOON</span></div>
    </article>
  `).join('');
}
